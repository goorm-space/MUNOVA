pipeline {
    ...
    environment {
            ...
            SPRING_DATASOURCE_PASSWORD = credentials('MUNOVA-DB-PASSWORD')
            SPRING_REDIS_PASSWORD      = credentials('MUNOVA-REDIS-PASSWORD')
            TOSS_PAYMENTS_SECRET       = credentials('MUNOVA-TOSS-SECRET')
            AWS_ACCESS_KEY             = credentials('MUNOVA-AWS-ACCESS')
            AWS_SECRET_KEY             = credentials('MUNOVA-AWS-SECRET')
        }
