...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, TmpOrderDto> tmpOrderRedisTemplate() {
        RedisTemplate<String, TmpOrderDto> redisTemplate = new RedisTemplate<>();
        redisTemplate.setConnectionFactory(redisConnectionFactory());

        redisTemplate.setKeySerializer(new StringRedisSerializer());
        redisTemplate.setValueSerializer(new Jackson2JsonRedisSerializer<>(TmpOrderDto.class));
