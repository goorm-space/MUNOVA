...
class CartCommandServiceTest {
    ...
    void findCartItemByMember_Success() {
        ...
        // When
        PagingResponse<FindCartInfoResponseDto> result = cartCommandService.findCartItemByMember(pageable, memberId);
    ...
    void deleteByProductDetailIds_Success() {
        ...
        // When
        cartCommandService.deleteByProductDetailIds(productDetailIds);
