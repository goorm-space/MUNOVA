...
import com.space.munova.product.application.product.command.ProductImageCommandService;
...
//    }
    ...
    void findLikeProducts_Success() {
        ...
        PagingResponse<FindProductResponseDto> result =
                productLikeCommandService.findLikeProducts(pageable, member.getId());
