...
//import com.space.munova.product.application.product.command.*;
//import com.space.munova.product.application.product.command.dto.*;
...
//        when(brandCommandService.findById(1L)).thenReturn(brand);
//        when(categoryCommandService.findById(1L)).thenReturn(category);
//        when(productRepository.save(any(Product.class))).thenReturn(savedProduct);
//        doNothing().when(productImageCommandService).saveMainImg(any(MultipartFile.class), any(Product.class));
//        doNothing().when(productImageCommandService).saveSideImg(anyList(), any(Product.class));
...
//        verify(brandCommandService, times(1)).findById(1L);
//        verify(categoryCommandService, times(1)).findById(1L);
//        verify(productRepository, times(1)).save(any(Product.class));
//        verify(productImageCommandService, times(1)).saveMainImg(any(MultipartFile.class), any(Product.class));
//        verify(productImageCommandService, times(1)).saveSideImg(anyList(), any(Product.class));
...
//        doNothing().when(productImageCommandService).updateMainImg(any(MultipartFile.class), any(Product.class));
//        doNothing().when(productImageCommandService).saveSideImg(anyList(), any(Product.class));
//        doNothing().when(productImageCommandService).deleteImagesByImgIds(anyList(), any(Long.class));
//        doNothing().when(productDetailService).saveProductDetailAndOption(any(Product.class), anyList());
...
//        verify(productImageCommandService, times(1)).updateMainImg(any(MultipartFile.class), any(Product.class));
//        verify(productImageCommandService, times(1)).saveSideImg(anyList(), any(Product.class));
//        verify(productImageCommandService, times(1)).deleteImagesByImgIds(anyList(), any(Long.class));
//        verify(productDetailService, times(1)).saveProductDetailAndOption(any(Product.class), anyList());
